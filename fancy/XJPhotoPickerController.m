...
//#import "XJPhotoPreviewViewController.h"
...
@interface XJPhotoPickerController ()
...
@property(nonatomic,weak) PickphotoViewController *showFromViewController;
@property(nonatomic,assign) UIImagePickerControllerSourceType sourceType;

@end


@implementation XJPhotoPickerController
...
- (id)initWithPresentingViewController:(PickphotoViewController *)aViewController withCompletionBlock:(XJPhotoPickerCompletionBlock)completionBlock;
{
    self = [super init];
...
//        }];
        //[self.showFromViewController setImage:image chooseBlock:^{
            [self.popoverController dismissPopoverAnimated:YES];
            self.completionBlock(picker, info);
       // } cancelBlock:^{
         //   [picker popViewControllerAnimated:YES];
