...
\begin{figure}
    ...
    \SetFigLayout{1}{1}
    {\includegraphics[%
    width=\figwidth, totalheight=\figheight, keepaspectratio]{./screenshots/storyboard-stats.png}}
    \caption{Storyboard of Statistics View}
\end{figure}
...
\begin{figure}
    ...
    \SetFigLayout{1}{1}
    {\includegraphics[%
    width=\figwidth, totalheight=\figheight, keepaspectratio]{./screenshots/storyboard-settings.png}}
    \caption{Storyboard of Settings View}
\end{figure}
...
\begin{figure}
    ...
    \SetFigLayout{1}{1}
    {\includegraphics[%
    width=\figwidth, totalheight=\figheight, keepaspectratio]{./screenshots/storyboard-map.png}}
    \caption{Storyboard of Map View}
\end{figure}
